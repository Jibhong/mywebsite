...
export default function HomeContent() {
  ...
  useEffect(() => {
    ...
    async function autoRun() {
      // const params = await promise_params || null;

      const res_markdown = await fetch(`${BLOB}/blog_pages/hello/content.md`);
      const res_meetadata = await fetch(`${BLOB}/blog_pages/hello/metadata.json`)
  ...
  return (
     <div className="pt-30 font-sans bg-orange-50 min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-4 max-w-4xl mx-auto w-full">
        ...
        {!preview ? (
          <textarea
            className="text-gray-600 w-full h-80 p-3 border rounded font-mono"
            value={markdown}
